...
button1 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button1_status, 1))
button1.grid(row=0, column=0)
button2 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button2_status, 2))
button2.grid(row=0, column=1)
button3 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button3_status, 3))
button3.grid(row=0, column=2)
button4 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button4_status, 4))
button4.grid(row=1, column=0)
button5 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button5_status, 5))
button5.grid(row=1, column=1)
button6 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button6_status, 6))
button6.grid(row=1, column=2)
button7 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button7_status, 7))
button7.grid(row=2, column=0)
button8 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button8_status, 8))
button8.grid(row=2, column=1)
button9 = tkinter.Button(canvas, image=blank, width=100, height=100, command=lambda: click(button9_status, 9))
